...
export default function Header() {
  ...
  `;
    const redirectToGmail = () => {
        const email = "sabbirahamedsiam101@gmail.com";
        const subject = ""; // Customize as needed
        const body = "Hi"; // Customize as needed
        ...
        <div className=" 2xl:mx-[7%] mx-[5%] relative">
            ...
            <section className=" flex lg:flex-row flex-col lg:items-center items-start mt-6 lg:justify-between ">
                <div className="  sm:ml-5">
                    ...
                    > Let ' s Talk</h3>
                    <p  data-tip="send me email" className="text-black tooltip scroll-auto cursor-pointer sm:text-2xl text-xl font-medium leading-[1.4] tracking-[-0.01em] text-left" >
