    ...
    return (
        <div className="navbar bg-base-100 mt-7 px-[5%]">
            ...
            <div className="navbar-end">
                <a href='https://www.fiverr.com/sabbirahamedsia?up_rollout=true' target='_blank' data-tip="Hire me on fiverr" className="tooltip hidden sm:block text-[20px] lg:text-[22px] cursor-pointer font-semibold bg-black text-white py-2 lg:py-4 px-4 lg:px-7 rounded-md hover:scale-95 duration-300 ">Hire me  &#128075; </a>
